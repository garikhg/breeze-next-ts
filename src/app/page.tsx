                ...
                <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div className="flex lg:col-start-2 lg:justify-center">
                            <svg className="h-12 w-auto text-white lg:h-16 lg:text-[#FF2D20]"
                                 viewBox="0 0 62 65"
                                 fill="none"
                        ...
                        <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                    ...
                                    <div id="docs-card-content" className="flex items-start gap-6 lg:flex-col">
                                        <div
                                            ...
                                            >
                                                ...
                                                <path fill="#FF2D20"
                                                      d="m3.55 1.893 8 4.048a1.008 1.008 0 0 0 .9 0l8-4.048a1 1 0 0 0-.9-1.785l-7.322 3.706a.506.506 0 0 1-.452 0L4.454.108a1 1 0 0 0-.9 1.785H3.55Z"></path>
                                            </svg>
                                        </div>
                            ...
                            >
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     ...
                                     strokeWidth={1.5}
                                     stroke="currentColor"
                                     className="size-6 self-center shrink-0 stroke-[#FF2D20]"
                                >
                                    <path strokeLinecap="round"
                                          strokeLinejoin="round"
                                          d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3"
